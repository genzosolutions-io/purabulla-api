...
/* harmony import */ var _nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
/* harmony import */ var _nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _follows_follows_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../follows/follows.module */ "./apps/api/src/app/endpoints/follows/follows.module.ts");
/* harmony import */ var _article_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./article.controller */ "./apps/api/src/app/endpoints/articles/article.controller.ts");
/* harmony import */ var _article_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./article.service */ "./apps/api/src/app/endpoints/articles/article.service.ts");
    ...
    Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Module"])({
        imports: [
            _nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2__["MongooseModule"].forFeature([
                {
                    name: _schemas_article_schema__WEBPACK_IMPORTED_MODULE_6__["Article"].name,
                    schema: _schemas_article_schema__WEBPACK_IMPORTED_MODULE_6__["ArticleSchema"].index({ url: true }, { unique: true })
                },
            ]),
            _nestjs_common__WEBPACK_IMPORTED_MODULE_1__["HttpModule"],
            _follows_follows_module__WEBPACK_IMPORTED_MODULE_3__["FollowsModule"],
        ],
        controllers: [_article_controller__WEBPACK_IMPORTED_MODULE_4__["ArticlesController"]],
        providers: [_article_service__WEBPACK_IMPORTED_MODULE_5__["ArticlesService"]],
        exports: [_article_service__WEBPACK_IMPORTED_MODULE_5__["ArticlesService"], _nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2__["MongooseModule"]],
    })
], ArticlesModule);
...
/* harmony import */ var _follows_follows_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../follows/follows.service */ "./apps/api/src/app/endpoints/follows/follows.service.ts");
/* harmony import */ var _schemas_article_schema__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./schemas/article.schema */ "./apps/api/src/app/endpoints/articles/schemas/article.schema.ts");
var _a, _b;
...
let ArticlesService = class ArticlesService {
    constructor(articleModel, followsService) {
...
ArticlesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_nestjs_mongoose__WEBPACK_IMPORTED_MODULE_2__["InjectModel"])(_schemas_article_schema__WEBPACK_IMPORTED_MODULE_5__["Article"].name)),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [typeof (_a = typeof mongoose__WEBPACK_IMPORTED_MODULE_3__["Model"] !== "undefined" && mongoose__WEBPACK_IMPORTED_MODULE_3__["Model"]) === "function" ? _a : Object, typeof (_b = typeof _follows_follows_service__WEBPACK_IMPORTED_MODULE_4__["FollowsService"] !== "undefined" && _follows_follows_service__WEBPACK_IMPORTED_MODULE_4__["FollowsService"]) === "function" ? _b : Object])
], ArticlesService);
...
EndpointsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_nestjs_common_decorators_modules_module_decorator__WEBPACK_IMPORTED_MODULE_1__["Module"])({
        imports: [
            ...
            // MongooseModule.forFeatureAsync([{ name: Like.name, useFactory: () => {
            //   const schema = LikeSchema;
            //   schema.post('save', () => {
            //     Logger.log('saved like!');
            //   });
            //   schema.post('deleteOne', () => {
            //     Logger.log('removed like');
            //   })
            // } }]),
...
let SharesService = class SharesService {
    ...
    getUserShares(user_id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.shareModel.find({}).where('user').equals(mongoose__WEBPACK_IMPORTED_MODULE_3__["Types"].ObjectId(user_id)).exec();
        });
    }
    findAll() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                articles.forEach((article) => {
                    ...
                    bulkOperation.find({ _id: article._id }).update({ $set: { score: calculated_score } });
                });
